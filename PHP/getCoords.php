...
$apiKey = getenv('getCoordsAPIKEY');
$executionStartTime = microtime(true);

$capital = isset($_GET['capital']) ? urlencode($_GET['capital']) : '';
$country = isset($_GET['countryCode']) ? urlencode($_GET['countryCode']) : '';

$url = "http://api.openweathermap.org/geo/1.0/direct?q=" . $capital . "," . $country . "&appid=" . $apiKey ;
